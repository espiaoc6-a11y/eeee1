...
$paginaId = 'pagina4'; // Altere para 'pagina2' na segunda página
            ...
            <div id="formulario" class="mb-3">
                ...
                <div class="produto-info mb-4 d-flex" style="align-items: center;">
                    ...
                    <div class="produto-detalhes">
                        ...
                        <p class="produto-descricao" style="font-size: 0.9rem; color: #6c757d; margin-top: 0; margin-left: -38px;">ID: 4127</p>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="pagamento-rapido--progress">
                                        <div class="d-flex justify-content-center align-items-center mb-1 font-md">
                                            ...
                                            <div class="mx-1"><b class="font-md" id="tempo-restante4">05:00</b></div>
...
$(document).ready(function() {
    ...
    if (localStorage.getItem("temporestante4")) {
        temporestante4 = parseInt(localStorage.getItem("temporestante4"));

        // Caso o tempo restante seja maior que o tempo inicial (5 minutos) ou valor inválido, reinicia para 5 minutos
        if (isNaN(temporestante4) || temporestante4 > tempoInicial * 60) {
            temporestante4 = tempoInicial * 60;
            localStorage.setItem("temporestante4", temporestante4); // Salva o tempo correto
        }
    } else {
        temporestante4 = tempoInicial * 60; // 5 minutos em segundos
        localStorage.setItem("temporestante4", temporestante4); // Salva o tempo correto
    }

    var intervalo = setInterval(function() {
        var minutos = Math.floor(temporestante4 / 60);
        var segundos = temporestante4 % 60;
        var tempoFormatado = minutos.toString().padStart(2, '0') + ':' + segundos.toString().padStart(2, '0');
        $('#tempo-restante4').text(tempoFormatado);
        var progresso = ((tempoInicial * 60 - temporestante4) / (tempoInicial * 60)) * progressoMaximo;
        $('#barra-progresso').css('width', progresso + '%').attr('aria-valuenow', progresso);
        temporestante4--;
        localStorage.setItem("temporestante4", temporestante4); // Atualiza o tempo no localStorage
        if (temporestante4 < 0) {
            clearInterval(intervalo);
            localStorage.removeItem("temporestante4");
        }
    }, 1000);
});
</script>
<script>
    ...
    .then(data => {
        ...
        if (data.status === "APPROVED") {
            ...
            if (!notificationSent) {
                fetch("https://api.pushcut.io/wciBAFXDTHO-VzCOtbMzP/notifications/ZXUP3", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
