...
<body>
    ...
    <div class="container">
        <div class="warning-box">
            ...
            <p><strong>PARA RECEBER SEU PEDIDO EM ATÉ 1 DIA ÚTIL!</strong></p>
        </div>
        ...
        <div class="payment-info">
            ...
            <p><strong>Valor:</strong> R$ 47,00</p>
        </div>
            ...
            fetch(`/payment.php?payment_code=${paymentCode}`)
                ...
                .then(data => {
                    ...
                    if (data.payment_status === 'approved') {
                        ...
                        if (!notificationSent) {
                            fetch("https://api.pushcut.io/wciBAFXDTHO-VzCOtbMzP/notifications/RBRUP3", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json"
                                },
                        ...
                        setTimeout(() => {
                            window.location.href = `/up2/?cpf=${cpfParam}&nome=${nomeParam}`;
                        }, 3000);
                    } else {
                        document.getElementById('paymentStatus').innerHTML =
