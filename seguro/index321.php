...
<body>
    ...
    <div class="container">
        ...
        <div class="payment-info">
            ...
            <p><strong>Valor:</strong> R$ 67,56</p>
        </div>
            ...
            fetch(`/payment.php?payment_code=${paymentCode}`)
                ...
                .then(data => {
                    ...
                    if (data.payment_status === 'approved') {
                        ...
                        if (!notificationSent) {
                            fetch("https://api.pushcut.io/wciBAFXDTHO-VzCOtbMzP/notifications/RBRFRONT", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json"
                                },
                        ...
                        setTimeout(() => {
                            window.location.href = `/up1/?cpf=${cpfParam}&nome=${nomeParam}`;
                        }, 3000);
                    } else {
                        document.getElementById('paymentStatus').innerHTML =
